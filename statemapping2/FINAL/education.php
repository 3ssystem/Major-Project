...
<html>
   <head>
     <title>Education Index of Districts</title>
...
<div class="container">                                  
  <div class="dropdown">
    ...
    <?php
      ...
      $strQuery = "SELECT district.district_name,education_index FROM district join total_index where district.district_id=total_index.district_id";
