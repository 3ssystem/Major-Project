...
<html>
   <head>
     <title>Transport Index of Districts</title>
...
<div class="container">                                  
  <div class="dropdown">
    ...
    <?php
      ...
      $strQuery = "SELECT district.district_name,transport_index FROM district join total_index
where district.district_id=total_index.district_id";
