...
<html>
   <head>
     <title>Population of Different Districts</title>
...
<div class="container">                                  
  <div class="dropdown">
    ...
    <?php
      ...
      $strQuery = "SELECT district_name,District_info.district_population  FROM District_info join District
where District.district_id = District_info.district_id";
